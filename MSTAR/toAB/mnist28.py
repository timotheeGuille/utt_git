...
#dirMnist_28=os.path.dirname(os.getcwd()) + "mnist_png_28\\dataset\\"

dirMnist_28= param.mnist_28_dir
...
#       reseau 
#------------------------------------------------------------------------#
generator = network_model.make_generator_model_28()
discriminator = network_model.make_discriminator_model_28()
